...
export const updateInventory = async (productId, newInventory) => {
  ...
  return fetch(`https://webshop-9434b-default-rtdb.europe-west1.firebasedatabase.app/products/${productId}.json`, {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json'
    },
    ...
    .then(data => {
      console.log(`Inventory of product ${productId} updated to ${newInventory}`);
      return data;
    })
    .catch(error => {
      console.error(error);
